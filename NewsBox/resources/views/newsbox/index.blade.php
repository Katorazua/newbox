...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container-fluid">
                    ...
                    <nav class="classy-navbar justify-content-between" id="newsboxNav">
                        ...
                        <!-- Nav brand -->
                        <a href="index.html" class="nav-brand"><img src="{{ asset('newsbox/img/core-img/logo.png') }}" alt=""></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <div class="header-add-area">
                                    <a href="#">
                                       <img src="{{ asset('newsbox/img/bg-img/add.png') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <!-- Nav End -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-post style-1" data-animation="fadeInUpBig" data-delay="100ms" data-duration="1000ms">
                                ...
                                <div class="blog-thumbnail bg-overlay">
                                    <a href="#"><img src="{{ asset('newsbox/img/bg-img/1.jpg') }}" alt=""></a>
                                </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="single-blog-post style-1" data-animation="fadeInUpBig" data-delay="500ms" data-duration="1000ms">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail bg-overlay">
                                    <a href="#"><img src="{{ asset('newsbox/img/bg-img/3.jpg') }}" alt=""></a>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-blog-post style-2 mb-5">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="{{ asset('newsbox/img/bg-img/9.jpg') }}" alt=""></a>
                        </div>
    ...
    <div class="big-add-area mb-100">
        <div class="container-fluid">
            <a href="#"><img src="{{ asset('newsbox/img/bg-img/add2.png') }}" alt=""></a>
        </div>
    </div>
    <!-- ##### Add Area End ##### -->
